...
// Class used to get the cam information
        ...
        controller.startImageStream((CameraImage img) {
          if (!isDetecting) {
            ...
            Tflite.detectObjectOnFrame(
              ...
              imageMean: 127.5,
              imageStd: 127.5,
              numResultsPerClass: 1,  //came with 1
              threshold: 0.4,         //came with 0.4
            ).then((recognitions) {
              // When setRecognitions is called here,
              // the parameters are being passed on to the parent widget as callback. i.e. to the LiveFeed class
